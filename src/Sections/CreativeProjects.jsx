...
const CreativeProjects = () => {
  ...
  return (
   <>
   <div className='container mx-auto py-[40px] creativeproj'>

<div>
<div className='py-[30px]  '>
        <h3 className='text-[38px] font-semibold text-black font-karla'>Some of Our Creative projects <br></br>
        <span className='text-[#503af2]'> Crafted at Hope Valley</span>
        </h3>
        </div>
        <div className=' pt-[20px] creativeProject-slider'>
